  ...
  try {
    ...
    if (data.length > 0) {
      ...
      const bedrijvenInSectorIndustrie = geojsonData.features.filter(
        (feature) => feature.properties.aangepaste_sector === "Industrie, Energie en Raffinaderijen"
      );

      // Bereken de afstand tussen de huidige locatie en de bedrijven in de sector
      const bedrijvenMetAfstandIndustrie = bedrijvenInSectorIndustrie.map((bedrijf) => ({
        ...bedrijf,
        afstand: calculateDistance(lat, lon, bedrijf.geometry.coordinates[1], bedrijf.geometry.coordinates[0]),
      }));
      ...
      const dichtsbijzijndeBedrijvenIndustrie = bedrijvenMetAfstandIndustrie.slice(0, 3);

      // Update de HTML met de bedrijfsnamen
      document.querySelector("#card23 .mt-6 .text-xl:nth-of-type(1)").textContent = dichtsbijzijndeBedrijvenIndustrie[0]?.properties.bedrijf || "Geen gegevens";
      document.querySelector("#card23 .mt-6 .text-xl:nth-of-type(2)").textContent = dichtsbijzijndeBedrijvenIndustrie[1]?.properties.bedrijf || "Geen gegevens";
      document.querySelector("#card23 .mt-6 .text-xl:nth-of-type(3)").textContent = dichtsbijzijndeBedrijvenIndustrie[2]?.properties.bedrijf || "Geen gegevens";
      ...
      const bedrijvenInSectorVerkeer = geojsonData.features.filter(
        (feature) => feature.properties.aangepaste_sector === "Verkeer en vervoer"
      );

      // Bereken de afstand tussen de huidige locatie en de bedrijven in de sector
      const bedrijvenMetAfstandVerkeer = bedrijvenInSectorVerkeer.map((bedrijf) => ({
        ...bedrijf,
        afstand: calculateDistance(lat, lon, bedrijf.geometry.coordinates[1], bedrijf.geometry.coordinates[0]),
      }));
      ...
      // Selecteer de 3 dichtstbijzijnde bedrijven
      const dichtsbijzijndeBedrijvenVerkeer = bedrijvenMetAfstandVerkeer.slice(0, 3);

      // Update de HTML met de bedrijfsnamen
      document.querySelector("#card33 .mt-6 .text-xl:nth-of-type(1)").textContent = dichtsbijzijndeBedrijvenVerkeer[0]?.properties.bedrijf || "Geen gegevens";
      document.querySelector("#card33 .mt-6 .text-xl:nth-of-type(2)").textContent = dichtsbijzijndeBedrijvenVerkeer[1]?.properties.bedrijf || "Geen gegevens";
      document.querySelector("#card33 .mt-6 .text-xl:nth-of-type(3)").textContent = dichtsbijzijndeBedrijvenVerkeer[2]?.properties.bedrijf || "Geen gegevens";
      ...
      const bedrijvenInSectorAfval = geojsonData.features.filter(
        (feature) => feature.properties.aangepaste_sector === "Afval, riolering, waterzuivering"
      );

      // Bereken de afstand tussen de huidige locatie en de bedrijven in de sector
      const bedrijvenMetAfstandAfval = bedrijvenInSectorAfval.map((bedrijf) => ({
        ...bedrijf,
        afstand: calculateDistance(lat, lon, bedrijf.geometry.coordinates[1], bedrijf.geometry.coordinates[0]),
      }));
      ...
      // Selecteer de 3 dichtstbijzijnde bedrijven
      const dichtsbijzijndeBedrijvenAfval = bedrijvenMetAfstandAfval.slice(0, 3);

      // Update de HTML met de bedrijfsnamen
      document.querySelector("#card43 .mt-6 .text-xl:nth-of-type(1)").textContent = dichtsbijzijndeBedrijvenAfval[0]?.properties.bedrijf || "Geen gegevens";
      document.querySelector("#card43 .mt-6 .text-xl:nth-of-type(2)").textContent = dichtsbijzijndeBedrijvenAfval[1]?.properties.bedrijf || "Geen gegevens";
      document.querySelector("#card43 .mt-6 .text-xl:nth-of-type(3)").textContent = dichtsbijzijndeBedrijvenAfval[2]?.properties.bedrijf || "Geen gegevens";
      ...
      const bedrijvenInSectorHandel = geojsonData.features.filter(
        (feature) => feature.properties.aangepaste_sector === "Handel/Diensten/Overheid en Bouw"
      );

      // Bereken de afstand tussen de huidige locatie en de bedrijven in de sector
      const bedrijvenMetAfstandHandel = bedrijvenInSectorHandel.map((bedrijf) => ({
        ...bedrijf,
        afstand: calculateDistance(lat, lon, bedrijf.geometry.coordinates[1], bedrijf.geometry.coordinates[0]),
      }));
      ...
      // Selecteer de 3 dichtstbijzijnde bedrijven
      const dichtsbijzijndeBedrijvenHandel = bedrijvenMetAfstandHandel.slice(0, 3);

      // Update de HTML met de bedrijfsnamen
      document.querySelector("#card53 .mt-6 .text-xl:nth-of-type(1)").textContent = dichtsbijzijndeBedrijvenHandel[0]?.properties.bedrijf || "Geen gegevens";
      document.querySelector("#card53 .mt-6 .text-xl:nth-of-type(2)").textContent = dichtsbijzijndeBedrijvenHandel[1]?.properties.bedrijf || "Geen gegevens";
      document.querySelector("#card53 .mt-6 .text-xl:nth-of-type(3)").textContent = dichtsbijzijndeBedrijvenHandel[2]?.properties.bedrijf || "Geen gegevens";
      ...
      // Bereken de afstand tussen de huidige locatie en de bedrijven in de sector
      const bedrijvenMetAfstandLandbouw = bedrijvenInSectorLandbouw.map((bedrijf) => ({
        ...bedrijf,
        afstand: calculateDistance(lat, lon, bedrijf.geometry.coordinates[1], bedrijf.geometry.coordinates[0]),
      }));
      ...
      // Selecteer de 3 dichtstbijzijnde bedrijven
      const dichtsbijzijndeBedrijvenLandbouw = bedrijvenMetAfstandLandbouw.slice(0, 3);
